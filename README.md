...
two word lists (HSK1 and a textbook list you can label however you like, e.g. `ES1`)
with support for adding your own words and tags.
...
- `data.js` — the HSK1 (300 words) and ES1 word list data
...
- Add HSK2+ word lists, or a CSV/JSON import for your own textbook lists.
