...
seven built-in word lists (HSK1, HSK2, HSK3, HSK4, HSK5, and textbook lists you can label however you
...
- `data.js` — the HSK1, HSK2, HSK3, HSK4, HSK5, ES1, and ES2 word list data
