...
eight built-in word lists (HSK1, HSK2, HSK3, HSK4, HSK5, HSK6, and textbook lists you can label however you
like, e.g. `ES1`/`ES2`) with support for adding your own words and tags. Built-in lists are
...
- `data.js` — the HSK1, HSK2, HSK3, HSK4, HSK5, HSK6, ES1, and ES2 word list data
...
- Add a CSV/JSON import for your own textbook lists.
