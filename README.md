...
six built-in word lists (HSK1, HSK2, HSK3, HSK4, HSK5, and a textbook list you can label however you
...
- `data.js` — the HSK1, HSK2, HSK3, HSK4, HSK5, and ES1 word list data
